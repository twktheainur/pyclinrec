...
from intersection_recognizers import InterDoubleMetaphoneConceptRecognizer, IntersStemConceptRecognizer
...
class TestRecognizers:
    ...
    def test_stem_recognize(self):
        dictionary_loader = StringDictionaryLoader([("1", "bright cat"), ("2", "Brighton")])
        recognizer = IntersStemConceptRecognizer(dictionary_loader, "../data/stopwordsen.txt",
                                                 "../data/termination_termsen.txt")
        recognizer.initialize()
